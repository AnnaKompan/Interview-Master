...
export class TypingAnimation {
  // @input для того щоб можна було передавати текст для анімації
  ...
  // ngOnChanges викликається щоразу, коли змінюється вхідне значення (в даному випадку appTypingAnimation).
